...
<body <?php body_class('body'); ?>>
    ...
    <?php do_action('aphm_header_notice'); ?>	
                    ...
                    <div class="row">
                        ...
                        <nav class="header-nav">
                            ...
                            <div class="menu-wrapper max-width-1100">
                                <h1 class="menu-title underline">Menu</h1>
    ...
    <?php do_action('aphm_cookie_notice'); ?>	
