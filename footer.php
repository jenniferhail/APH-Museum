    ...
    <footer class="footer">
        <div class="wrapper">
            <div class="logo-div">
                <a href="./" target="_blank" rel="noreferrer" class="logo-link">
            ...
            <div class="content">
                ...
                <a href="#" target="_blank" rel="noreferrer">
                    <img src="<?php echo get_template_directory_uri(); ?>/dist/images/logo-louisvilletourism-white.svg" alt="Louisville Tourism logo" class="logo-small">
                </a>
            </div>
        </div>
    </footer>
