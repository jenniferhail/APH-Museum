<?php
    ...
    function person_categories() {
        $labels = [
            'name'                       => _x('Person Categories', 'Taxonomy General Name', 'text_domain'),
            'singular_name'              => _x('Person Category', 'Taxonomy Singular Name', 'text_domain'),
        ...
        register_taxonomy('person_categories', [ 'person' ], $args);
    }
    add_action('init', 'person_categories', 0);
