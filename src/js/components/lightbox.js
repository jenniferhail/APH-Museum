...
export default function lightbox() {
	...
	// This is a function for lightboxes with glide sliders
	var initPhotoSwipeFromDOM = function (gallerySelector) {
		...
		var parseThumbnailElements = function (el) {
			...
			for (var i = 0; i < numNodes; i++) {
				...
				// Exclude the cloned sides from glide
				if (figureEl.className.indexOf("glide__slide--clone") > 0) {
					continue;
				}
		...
		var openPhotoSwipe = function (
			...
			gallery.listen("afterChange", function () {
				var glideIndex = gallery.currItem.el.dataset.glideindex;
				console.log("Glide index: " + glideIndex);
				glide.go("=" + glideIndex);
			});
		};
	...
	initPhotoSwipeFromDOM(".glide__slides");
}
