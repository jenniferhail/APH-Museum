		...
		<ul class="social-menu">
			...
			<li class="menu-item">
				<a href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>&amp;text=<?php the_title(); ?>"
					target="_blank">
					<span class="visually-hide-text">Share on Twitter</span>
			...
			<li class="menu-item">
				<a href="mailto:?&subject=<?php the_title(); ?>&body=Check this out! <?php the_permalink(); ?>" target="_blank">
					<span class="visually-hide-text">Email this page</span>
